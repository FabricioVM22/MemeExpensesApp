...
export default function BottomNav({ activeView, setActiveView }: BottomNavProps): React.ReactNode {
  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 h-16 bg-surface/50 backdrop-blur-xl border-t border-border flex justify-around max-w-lg mx-auto shadow-top z-10 md:hidden">
      <NavItem
